...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(PaymentAccountAlreadyExistsException.class)
    public ResponseEntity<ErrorResponse> handlePaymentAccountAlreadyExistsException(PaymentAccountAlreadyExistsException ex) {
        ErrorResponse error = new ErrorResponse();
        error.setStatus(HttpStatus.CONFLICT);
        error.setMessage(ex.getMessage());
        error.setTimestamp(OffsetDateTime.now());
        log.warn("Payment Account Is Already Exists: {}", ex.getMessage());
        return new ResponseEntity<>(error, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(PaymentAccountIsNotEmptyException.class)
    public ResponseEntity<ErrorResponse> handlePaymentAccountIsNotEmptyException(PaymentAccountIsNotEmptyException ex) {
        ErrorResponse error = new ErrorResponse();
        error.setStatus(HttpStatus.CONFLICT);
        error.setMessage(ex.getMessage());
        error.setTimestamp(OffsetDateTime.now());
        log.warn("Payment Account Is Not Empty: {}", ex.getMessage());
        return new ResponseEntity<>(error, HttpStatus.CONFLICT);
    }

    @ExceptionHandler(PaymentAccountNotFoundException.class)
    public ResponseEntity<ErrorResponse> handlePaymentAccountNotFoundException(PaymentAccountNotFoundException ex) {
        ErrorResponse error = new ErrorResponse();
    ...
    @ExceptionHandler(UpdatePaymentAccountException.class)
    public ResponseEntity<ErrorResponse> handleUpdatePaymentAccountException(UpdatePaymentAccountException ex) {
        ErrorResponse error = new ErrorResponse();
        error.setStatus(HttpStatus.NOT_MODIFIED);
        error.setMessage(ex.getMessage());
        error.setTimestamp(OffsetDateTime.now());
        log.warn("Payment Account Is Not Updated: {}", ex.getMessage());
